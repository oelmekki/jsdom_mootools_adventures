...
exports.mootoolify = function(window, level){
	if (!window || !window.document) return;
	var core = ( level ? dom[level].core : dom.level3.core );

	core.Document.prototype.__defineSetter__("head", function(){
	});

	core.Document.prototype.__defineSetter__("id", function(id){
		this._id = id;
	});

	core.Document.prototype.__defineGetter__("id", function(){
		return this._id;
	});
}
